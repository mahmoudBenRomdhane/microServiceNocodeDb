...
export class UsersService {
  ...
  static async getToken() : Promise<any>{
    ...
    let config = {
      ...
      headers: { 
        ...
        'Cookie': 'refresh_token=7f090c83901cf25b14f513c8a54fe20e0dac3ec951c2780501d9bd349f89a9f86f84d46022d53229'
      },
      data : data
    };
  ...
  static async getProjects() : Promise<any>{
    ...
    let config = {
      ...
      headers: { 
        ...
        'Cookie': 'refresh_token=a76f010a6b08ba1c76b536fb0203eb6082cc6b5b72623aaa283eb3a6a6b481ede666b3322aa94205'
      }
    };
    try{
  ...
  static async getProject(projectId : string) {
    ...
    let config = {
      ...
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Cookie': 'refresh_token=78844d697f4510f8df00e3741c4e51b271c80ea5a199bce403c847edcb041ddf13d8fafada48f8b5'
      }
    };
    try{
      const response = await axios(config)
  ...
  static async getTable(id : any){
    ...
    let config = {
      ...
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Cookie': 'refresh_token=6436ed0dfbaa6c3bb6acc86818f78aa89e6ea660767ff41074f02b6f173ecd14b87fd9a428dfc023'
      }
    };
    try{
      const response = await axios(config)
  ...
  static async addColumn(col : any){
    ...
    let config = {
      ...
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Content-Type': 'application/json', 
        'Cookie': 'refresh_token=d7ba5ac86435b7e49c010ded53846b89b56149eca2981095e4c0ceff236fe8b7562d689d4deb082d'
      },
      data : data
    };
    try{
  ...
  static async getViews(tableId : string){
    ...
    let config = {
      ...
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Cookie': 'refresh_token=e4b8c97b16f84fedd2a42c4514f11f40d78b13dc483c66ccf8156418a4537be0f731fdd9571621aa'
      }
    };
    try{
      const response = await axios(config)
  ...
  static async getRows(getRowsInput){
    ...
    let config = {
      method: 'get',
      url: `http://145.239.168.115:8080/api/v1/db/data/noco/${getRowsInput.projectId}/${getRowsInput.tableId}/views/${getRowsInput.viewId}?offset=${(getRowsInput.page)-1}&limit=${getRowsInput.limit}`,
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Cookie': 'refresh_token=e4b8c97b16f84fedd2a42c4514f11f40d78b13dc483c66ccf8156418a4537be0f731fdd9571621aa'
      }
  ...
  static async getColumns(viewId){
    ...
    let config = {
      ...
      headers: { 
        'xc-auth': responseAuth.data.token, 
        'Cookie': 'refresh_token=db7698038e901cc0b46aa340cd8dbd98f4d35999a132994ad9472764ec32916d9e146aabd7a7c86f'
      }
    };
    try{
      const response = await axios(config)
